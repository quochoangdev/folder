...
namespace QL_THUVIEN.DAL
{
    ...
    {
        String diaChi = @"Data Source=(LocalDB)\MSSQLLocalDB;AttachDbFilename=C:\Users\Administrator\Desktop\QL_THUVIEN\QL_THUVIEN\QLTHUVIEN.mdf;Integrated Security=True";
        SqlConnection conn;
        public LopDungChung()
        {
